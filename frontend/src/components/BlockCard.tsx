            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
              ...
              {b.socialType === 'vk' && (
                <div style={{ 
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="white">
                    <path d="M13.162 18.994c.609 0 .858-.406.851-.915-.008-.511-.277-.956-.87-1.558l-2.35-2.35c.052-.281.106-.563.106-.845 0-2.34-1.921-5.225-5.384-5.225-2.94 0-4.839 1.688-4.839 3.949 0 2.204 1.709 3.41 3.934 3.41 1.31 0 2.662-.305 3.935-.844l.614 2.103c.224.695.664.915 1.403.915zm-3.262-7.163c-.494-.196-.997-.409-1.997-.409-1.213 0-1.936.925-1.936 2.116 0 1.29.782 2.092 2.025 2.092 1.09 0 1.667-.514 2.036-1.11l-1.128-1.689zm7.295 4.214c-.416 1.281-1.177 2.169-2.234 2.169-1.188 0-1.912-.915-1.912-2.178 0-1.407.87-2.048 1.912-2.048.494 0 .997.105 1.403.305l.614-2.103c-.494-.196-1.31-.305-2.025-.305-2.94 0-4.839 1.688-4.839 3.949 0 2.204 1.709 3.41 3.934 3.41 1.31 0 2.662-.305 3.935-.844l.614 2.103c.224.695.664.915 1.403.915z"/>
                  </svg>
                </div>
              )}
