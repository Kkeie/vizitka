...
- Use `/do-task` to start the automated workflow (same flow as Cursor skill `do-task` in `.cursor/skills/do-task/`).
- Cursor skills and subagents: `docs/agents/CURSOR.md`, `docs/agents/SUBAGENTS.md`.
